<form action="{{route('properties')}}" method="GET" class="flex justify-between home-search">
                    <div class="flex w-7/12 justify-between items-center ">
                        <div class="flex flex-col mx-3">
                            <label for="sale">Buy or Rent</label>
                            <select id="sale" name="sale" class="border-0 focus:ring-0 home-search" >
                        ...
                        <div class="flex flex-col mx-3">
                            ...
                            <select id="price" name="price"class="border-0 focus:ring-0">
                                ...
                                <option {{request('price') == '100000' ? 'selected="selected"' : ''}} value="100000">0 to 100000</option>
                                ...
                                <option {{request('price') == '5000002' ? 'selected="selected"' : ''}} value="5000002">500000 +</option>
                            </select>
                        </div>
                        <div class="py-3 self-center border-gray-500 border"></div>
                        <div class="flex flex-col mx-3">
                    ...
                    <div class="flex justify-between items-center w-92 ml-5">
                        ...
                        <button type="submit" class="btn color-white">Search</button>
                    </div>
                </form>