            ...
            <div class="flex justify-between">
                <div class="w-8/12">
                    ...
                    <h3 class="text-lg mt-2">Price: <span class="text-red-800">
                        {{ number_format($property->price, 2, ',', ',') }} TL</span></h3>
                </div>
                <div class="w-3/12">
                    <ul class="flex justify-end -mr-2">
                        <li>
                            <a class="flex flex-col justify-center items-center mx-2 border-2 border-gray-400 p-3 hover:border-red-400 duration-200"
                               href="#">
