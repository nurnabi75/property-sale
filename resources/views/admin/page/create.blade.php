            ...
            <div class="bg-white overflow-hidden shadow-sm sm:rounded-lg">
                <form action="{{route('dashboard-page.store')}}" method="post" class="p-6 bg-white border-b border-gray-200" enctype="multipart/form-data"> @csrf
                    ...
                    <div class="mb-6">
                        ...
                        <input class="property-input" type="text" id="slug" name="slug" value="{{old('slug')}}" required>
                    ...
                    <div class="mb-6">
                        ...
                        <textarea class="property-input" name="content" id="content" cols="30" rows="10" required>{{old('content')}}</textarea>
